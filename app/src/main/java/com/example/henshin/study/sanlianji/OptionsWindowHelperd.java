 ...
 */
public class OptionsWindowHelperd {
    ...
    private OptionsWindowHelperd() {
    }

    public static CharacterPickerWindowd builder(Activity activity, final OnOptionsSelectListener listener) {
        //选项选择器
        CharacterPickerWindowd mOptions = new CharacterPickerWindowd(activity);
        //初始化选项数据
    ...
    public static void setPickerData(CharacterPickerView view) {
        if (options1Items == null) {
            ...
            final Map<String, Map<String, List<String>>> allCitys = ArrayDataDemod.getAll();
