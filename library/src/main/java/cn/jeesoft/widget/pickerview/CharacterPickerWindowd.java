 ...
 */
public class CharacterPickerWindowd extends PopupWindow implements View.OnClickListener {
    ...
    public CharacterPickerWindowd(Context context) {
        super(context);
        ...
        rootView = mLayoutInflater.inflate(R.layout.j_picker_dialogd, null);
        // -----确定和取消按钮
